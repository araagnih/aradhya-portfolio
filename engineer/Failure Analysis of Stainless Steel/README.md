...
*The split barrel after failure. Instead of containing pressure, the barrel opened along its length — a clear indication of catastrophic failure. This image anchors the investigation: why did a nearly new stainless steel barrel fail under normal firing conditions?*  
...
*On the left, the standard composition of 416R stainless steel. On the right, the chemical test results from the failed barrel. The sulfur level (0.17%) exceeded the specification limit (0.13%). This seemingly small deviation promoted manganese sulfide (MnS) inclusions, reducing toughness and increasing anisotropy — a critical contributor to failure.*  
